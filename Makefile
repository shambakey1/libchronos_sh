...
$(LIBCHRONOS): $(LIBOBJS)
	@echo '  LD     ' $@
	@$(CC) $(CFLAGS) -shared -Wl,-soname,$(LIBCHRONOS) -o $(LIBCHRONOS) $(LIBOBJS) -lrt

$(CLEAR_SCHEDSTATS): clear_schedstats.c $(LIBCHRONOS)
	@echo '  LD     ' $(CLEAR_SCHEDSTATS)
	@$(CC) $(CFLAGS) clear_schedstats.c -o $(CLEAR_SCHEDSTATS) -lrt $(LIBCHRONOS)
